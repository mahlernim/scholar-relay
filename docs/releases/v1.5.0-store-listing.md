...
Scegli audio, video, report, quiz, schede didattiche, infografiche, presentazioni, mappe mentali e tabelle. Salva fino a 20 attività nella coda. Interrompi un’attività conservando o eliminando il notebook. I risultati incerti non causano ripetizioni indiscriminate di creazione o caricamento.
...
Accedi a Gemini Notebook. Nessun server dello sviluppatore, pubblicità o analisi dell’utilizzo. L’accesso facoltativo ai siti serve a rilevare articoli, cercare titoli e scaricare PDF. Indipendente da Google. Le modifiche al servizio possono influire sulla compatibilità.
